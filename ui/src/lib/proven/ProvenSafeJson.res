...
type rec jsonValue =
  ...
  | @as("object") Object(dict<jsonValue>)

// JavaScript bindings to proven/safe_json
module SafeJsonJs = {
  @module("proven/safe_json") @scope("SafeJson")
  external parse: string => jsResult<JSON.t> = "parse"

  @module("proven/safe_json") @scope("SafeJson")
  external stringify: (JSON.t, option<int>) => jsResult<string> = "stringify"

  @module("proven/safe_json") @scope("SafeJson")
  external isValid: string => bool = "isValid"

  @module("proven/safe_json") @scope("SafeJson")
  external get: (JSON.t, string) => jsResult<option<JSON.t>> = "get"

  @module("proven/safe_json") @scope("SafeJson")
  external getPath: (JSON.t, array<string>) => jsResult<option<JSON.t>> = "getPath"

  @module("proven/safe_json") @scope("SafeJson")
  external merge: (JSON.t, JSON.t) => jsResult<JSON.t> = "merge"

  @module("proven/safe_json") @scope("SafeJson")
  external validate: (JSON.t, JSON.t) => jsResult<bool> = "validate"
}
 ...
 */
let stringify = (json: JSON.t, ~indent: option<int>=?) => {
 ...
 */
let get = (json: JSON.t, key: string) => {
 ...
 * @returns Result with optional value or error
 */
let getPath = (json: JSON.t, path: array<string>) => {
 ...
 */
let merge = (json1: JSON.t, json2: JSON.t) => {
 ...
 */
let validate = (json: JSON.t, schema: JSON.t) => {
