...
-- FormDB ABI Type Definitions with Dependent Type Proofs
--
-- This module defines the ABI types for the FormDB/Lithoglyph database
...
-- Raw bytes representing serialized FormDB operation
public export
