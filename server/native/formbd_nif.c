...
//
// formbd_nif.c - Erlang NIF wrapper for FormBD Zig FFI
//
// This bridges Gleam (BEAM) to FormBD's libformbd.so

#include <erl_nif.h>
#include <string.h>
#include <stdint.h>

// Forward declarations for FormBD FFI functions
// These will be linked from libformbd.so
...
// Status codes (matches FormBD ABI)
#define STATUS_OK 0
...
ERL_NIF_INIT(formbd_nif, nif_funcs, load, NULL, NULL, NULL)
